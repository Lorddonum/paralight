        ...
        {isVisible && (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              >
                <button className="w-10 h-10 rounded-full border border-gray-300 bg-white text-gray-600 hover:border-gray-400 hover:text-gray-800 transition-all duration-200 flex items-center justify-center shadow-sm">
              ...
              <button
                onClick={scrollToTop}
                className="w-10 h-10 rounded-full border border-gray-300 bg-white text-gray-600 hover:border-gray-400 hover:text-gray-800 transition-all duration-200 flex items-center justify-center shadow-sm"
              >
